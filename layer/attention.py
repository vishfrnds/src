...
import models.layers.rope as rope
...
class SelfAttention:
  ...
  def __call__(self, x: Tensor, start_pos: int, positional_embedding: PositionEmbedding) -> Tensor:
      x = x.half()
      ...
      xq, xk = positional_embedding.apply_rotary_emb(xq, xk, start_pos, seq_len)
